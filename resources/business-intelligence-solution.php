...
<title>Lambda Technologies - Business Intelligent Solution</title>
...
<body>
	...
	<div id="content-wrapper">
    	...
    	<div id="img-lambda" class="img-lambda"><img src="img/solutions/business-intelligence-solution/big-pic.jpg" width="2000" height="957" /></div>        <!--) 0 center no-repeat;"-->
...
<div class="head_img"><img src="img/solutions/business-intelligence-solution/Business-Intelligent-Solution.png"/></div>
...
<div class="right_shadow"></div>
	<div id="tab_1_content" class="content show tab1">
    	...
    	<div class="slide_box">
    	<div class="slide_head" id="s1_tab1">QlikView Overview<div class="btn btn-close selected"></div></div>
        
        <div class="slide_content showcon selected" id="s1_content">
       	<b>Understand your business in brand new ways by:</b><br />
        <ul>
        	<li>Consolidating relevant data from multiple sources into a single application</li>
			<li>Exploring the associations in your data</li>
			<li>Enabling social decision making through secure, real-time collaboration</li>
			<li>Visualizing data with engaging, state-of-the-art graphics</li>
			<li>Searching across all data—directly and indirectly</li>
			<li>Interacting with dynamic apps, dashboards and analytics</li>
			<li>Accessing, analyzing and capturing data from mobile devices</li>
        </ul>
		<br /><br />
